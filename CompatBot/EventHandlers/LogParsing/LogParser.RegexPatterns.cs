...
internal partial class LogParser
{
    ...
    [GeneratedRegex(@"Installation ID: (?<hw_id>[^\r\n]+)\r?$", DefaultOptions)]
    ...
    [GeneratedRegex(@"Found [Vv]ulkan-compatible GPU: (?<vulkan_found_device>'(?<vulkan_compatible_device_name>.+)' running[^\r\n]+)\r?$", DefaultOptions)]
    private static partial Regex VulkanDeviceName();
    [GeneratedRegex(@"Finished reading database from file: (?<compat_database_path>.*compat_database.dat).*$", DefaultOptions)]
    private static partial Regex CompatDbFoundPath();
    [GeneratedRegex(@"Database file not found: (?<compat_database_path>.*compat_database.dat).*$", DefaultOptions)]
    private static partial Regex CompatDbNotFoundPath();
    [GeneratedRegex(@"(?<fw_installed_message>Successfully installed PS3 firmware) version (?<fw_version_installed>\d+\.\d+).*$", DefaultOptions)]
    private static partial Regex FwInstallMessage();
    [GeneratedRegex(@"Firmware version: (?<fw_version_installed>\d+\.\d+).*$", DefaultOptions)]
    private static partial Regex FwVersion();
    [GeneratedRegex(@"(?:LDR|SYS): Title: (?<game_title>[^\r\n]*)?\r?$", DefaultOptions)]
    ...
    [GeneratedRegex(@"Category: (?<game_category>[^\r\n]*)?\r?$", DefaultOptions)]
    private static partial Regex GameCategory();
    [GeneratedRegex(@"Version: (?<disc_app_version>\S+) / (?<disc_package_version>\S+).*?$", DefaultOptions)]
    private static partial Regex DiscVersionLdr();
    [GeneratedRegex(@"Version: (APP_VER=)?(?<disc_app_version>\S+) (/ |VERSION=)(?<disc_package_version>\S+).*?$", DefaultOptions)]
    private static partial Regex DiscVersionSys();
    [GeneratedRegex(@"Cache: ((?<win_path>\w:/)|(?<lin_path>/[^/])).*?$", DefaultOptions)]
    private static partial Regex CachePathLdr();
    [GeneratedRegex(@"Cache: ((?<win_path>\w:/)|(?<lin_path>/[^/])).*?$", DefaultOptions)]
    private static partial Regex CachePathSys();
    [GeneratedRegex(@"Path: ((?<win_path>\w:/)|(?<lin_path>/[^/])).*?$", DefaultOptions)]
    ...
    [GeneratedRegex(@"[Ss]cheduler( Mode)?: (?<thread_scheduler>[^\r\n]*?)\r?$", DefaultOptions)]
    ...
    [GeneratedRegex(@"priority: (?<spu_lower_thread_priority>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex LowerThreadPriority();
    [GeneratedRegex(@"SPU Threads: (?<spu_threads>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex SpuThreadCount();
    [GeneratedRegex(@"SPU delay penalty: (?<spu_delay_penalty>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex SpuDelayPenalty();
    [GeneratedRegex(@"SPU loop detection: (?<spu_loop_detection>[^\r\n]*?)\r?$", DefaultOptions)]
    ...
    [GeneratedRegex(@"Accurate xfloat: (?<accurate_xfloat>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex AccurateXfloat();
    [GeneratedRegex(@"Approximate xfloat: (?<approximate_xfloat>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex ApproximateXfloat();
    [GeneratedRegex(@"Relaxed xfloat: (?<relaxed_xfloat>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex RelaxedXfloat();
    [GeneratedRegex(@"XFloat Accuracy: (?<xfloat_mode>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex XfloatMode();
    [GeneratedRegex(@"Accurate GETLLAR: (?<accurate_getllar>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex GetLlarMode();
    [GeneratedRegex(@"Accurate PUTLLUC: (?<accurate_putlluc>[^\r\n]*?)\r?$", DefaultOptions)]
    ...
    [GeneratedRegex(@"[Ll]oader: (?<lib_loader>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex LibLoaderMode();
    [GeneratedRegex(@"Hook static functions: (?<hook_static_functions>[^\r\n]*?)\r?$", DefaultOptions)]
    ...
    [GeneratedRegex(@"HLE lwmutex: (?<hle_lwmutex>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex HleLwmutex();
    [GeneratedRegex(@"Clocks scale: (?<clock_scale>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex ClockScale();
    [GeneratedRegex(@"Max CPU Preempt Count: (?<cpu_preempt_count>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex CpuPreemptCount();
    [GeneratedRegex(@"Sleep Timers Accuracy: (?<sleep_timer>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex SleepTimersMode();
    
    [GeneratedRegex(@"Enable /host_root/: (?<host_root>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex EnableHostRoot();

    [GeneratedRegex("Renderer: (?<renderer>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex RendererBackend();
    [GeneratedRegex("Resolution: (?<resolution>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex ResolutionMode();
    [GeneratedRegex("Aspect ratio: (?<aspect_ratio>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex AspectRatioMode();
    [GeneratedRegex("Frame limit: (?<frame_limit>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex FrameLimit();
    [GeneratedRegex("MSAA: (?<msaa>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex MsaaMode();
    [GeneratedRegex("Write Color Buffers: (?<write_color_buffers>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex Wcb();
    [GeneratedRegex("Write Depth Buffer: (?<write_depth_buffer>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex Wdb();
    [GeneratedRegex("Read Color Buffers: (?<read_color_buffers>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex Rcb();
    [GeneratedRegex("Read Depth Buffer: (?<read_depth_buffer>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex Rdb();
    [GeneratedRegex("VSync: (?<vsync>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex VsyncMode();
    [GeneratedRegex("Use GPU texture scaling: (?<gpu_texture_scaling>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex GpuTextureScaling();
    [GeneratedRegex("Stretch To Display Area: (?<stretch_to_display>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex StretchToDisplay();
    [GeneratedRegex("Strict Rendering Mode: (?<strict_rendering_mode>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex StrictRendering();
    [GeneratedRegex("Occlusion Queries: (?<zcull>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex OcclusionQueriesMode();
    [GeneratedRegex("Disable Vertex Cache: (?<vertex_cache>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex VertexCache();
    [GeneratedRegex("Enable Frame Skip: (?<frame_skip>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex FrameSkip();
    [GeneratedRegex("Blit: (?<cpu_blit>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex BlitMode();
    [GeneratedRegex("Disable Asynchronous Shader Compiler: (?<disable_async_shaders>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex DisableAsyncShaders();
    [GeneratedRegex("Shader Mode: (?<shader_mode>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex ShaderMode();
    [GeneratedRegex("Disable native float16 support: (?<disable_native_float16>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex DisableNativeF16();
    [GeneratedRegex("Multithreaded RSX: (?<mtrsx>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex RsxMultithreadMode();
    [GeneratedRegex("Relaxed ZCULL Sync: (?<relaxed_zcull>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex RelaxedZcull();
    [GeneratedRegex("Resolution Scale: (?<resolution_scale>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex ResolutionScaling();
    [GeneratedRegex("Anisotropic Filter Override: (?<af_override>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex AnisoFilter();
    [GeneratedRegex("Minimum Scalable Dimension: (?<texture_scale_threshold>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex ScalableDimensions();
    [GeneratedRegex("Driver Recovery Timeout: (?<driver_recovery_timeout>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex DriverRecoveryTimeout();
    [GeneratedRegex("Driver Wake-Up Delay: (?<driver_wakeup_delay>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex DriverWakeupDelay();
    [GeneratedRegex("Vblank Rate: (?<vblank_rate>[^\r\n]*?)\r?$", DefaultOptions)]
    ...
    [GeneratedRegex(@"Vulkan:\s*\r?\n\s*Adapter: (?<vulkan_gpu>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex SelectedVulkanDevice();
    [GeneratedRegex(@"Force FIFO present mode: (?<force_fifo_present>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex FifoPresentMode();
    [GeneratedRegex(@"Asynchronous Texture Streaming( 2)?: (?<async_texture_streaming>[^\r\n]*?)\r?$", DefaultOptions)]
    ...
    [GeneratedRegex("Master Volume: (?<audio_volume>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex MasterVolume();
    [GeneratedRegex("Enable Buffering: (?<audio_buffering>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex AudioBuffering();
    [GeneratedRegex("Desired Audio Buffer Duration: (?<audio_buffer_duration>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex AudioBufferLength();
    [GeneratedRegex("Enable Time Stretching: (?<audio_stretching>[^\r\n]*?)\r?$", DefaultOptions)]
    ...
    [GeneratedRegex("Use native user interface: (?<native_ui>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex NativeUIMode();
    [GeneratedRegex("Silence All Logs: (?<disable_logs>[^\r\n]*?)\r?$", DefaultOptions)]
    ...
    [GeneratedRegex(@"Invalid or unsupported file format: (?<failed_to_boot>[^\r\n]*?)\r?$", DefaultOptions)]
    private static partial Regex InvalidFileFormat();
    [GeneratedRegex(@"(?<failed_to_decrypt>Failed to decrypt)? SELF: (?<failed_to_decrypt>Failed to (decrypt|load SELF))?.*$", DefaultOptions)]
    private static partial Regex DecryptFailedSelfPath();
    [GeneratedRegex(@"Version: (APP_VER=)?(?<disc_app_version>\S+) (/ |VERSION=)(?<disc_package_version>\S+).*?$", DefaultOptions)]
    private static partial Regex GameVersion();
    [GeneratedRegex(@"Failed to verify (?<failed_to_verify_npdrm>(sce|npd)) file.*$", DefaultOptions)]
    ...
    [GeneratedRegex(@"GL RENDERER: (?<driver_manuf_new>[^\r\n]*?)\r?$", DefaultOptions)]
    ...
    [GeneratedRegex(@"GLSL VERSION: (?<glsl_version>(\d|\.)+).*?$", DefaultOptions)]
    ...
    [GeneratedRegex(@"Found [Vv]ulkan-compatible GPU: (?<vulkan_found_device>[^\r\n]+)\r?$", DefaultOptions)]
    ...
    [GeneratedRegex(@"RSX: Failed to compile shader: ERROR: (?<shader_compile_error>[^\r\n]+?)\r?$", DefaultOptions)]
    private static partial Regex FailedToCompileShader();
    [GeneratedRegex(@"RSX: Compilation failed: ERROR: (?<shader_compile_error>[^\r\n]+?)\r?$", DefaultOptions)]
    private static partial Regex ShaderCompilationFailed();
    [GeneratedRegex(@"RSX: Linkage failed: (?<shader_compile_error>[^\r\n]+?)\r?$", DefaultOptions)]
    ...
    [GeneratedRegex(@"Failed to locate the game license file: (?<rap_file>.*?\.rap).*$", DefaultOptions)]
    ...
    [GeneratedRegex(@"(?<native_ui_input>Pad handler expected but none initialized).*?$", DefaultOptions)]
    private static partial Regex MissingGamepad();
    [GeneratedRegex(@"Failed to bind device (?<failed_pad>.+) to handler (?<failed_pad_handler>.+).*$", DefaultOptions)]
    ...
    [GeneratedRegex(@"XAudio2Thread\s*: (?<xaudio_init_error>.+failed\s*\((?<xaudio_error_code>0x.+)\)[^\r\n]*)\r?$", DefaultOptions)]
    private static partial Regex XAudio2Thread();
    [GeneratedRegex(@"XAudio2Backend\s*: (?<xaudio_init_error>.+failed\s*\((?<xaudio_error_code>0x.+)\)[^\r\n]*)\r?$", DefaultOptions)]
    ...
    [GeneratedRegex(@"PPU executable hash: PPU-(?<ppu_patch>\w+( \(<-\s*\d+\))?).*?$", DefaultOptions)]
    private static partial Regex PpuHash();
    [GeneratedRegex(@"OVL executable hash: OVL-(?<ovl_patch>\w+( \(<-\s*\d+\))?).*?$", DefaultOptions)]
    private static partial Regex OvlHash();
    [GeneratedRegex(@"SPU executable hash: SPU-(?<spu_patch>\w+( \(<-\s*\d+\))?).*?$", DefaultOptions)]
    private static partial Regex SpuHash();
    [GeneratedRegex(@"PRX library hash: PRX-(?<prx_patch>\w+-\d+( \(<-\s*\d+\))?).*?$", DefaultOptions)]
    private static partial Regex PrxHash();
    [GeneratedRegex(@"OVL hash of (\w|[\.\[\]])+: OVL-(?<ovl_patch>\w+( \(<-\s*\d+\))?).*?$", DefaultOptions)]
    private static partial Regex OvlHash2();
    [GeneratedRegex(@"PRX hash of (\w|[\.\[\]])+: PRX-(?<prx_patch>\w+-\d+( \(<-\s*\d+\))?).*?$", DefaultOptions)]
    private static partial Regex PrxHash2();
    [GeneratedRegex(@"Applied patch \(hash='(?:\w{3}-\w+(-\d+)?)', description='(?<patch_desc>.+?)', author='(?:.+?)', patch_version='(?:.+?)', file_version='(?:.+?)'\) \(<- (?:[1-9]\d*)\).*$", DefaultOptions)]
    private static partial Regex AppliedPatch();
    [GeneratedRegex(@"Loaded SPU image: SPU-(?<spu_patch>\w+ \(<-\s*\d+\)).*?$", DefaultOptions)]
    private static partial Regex SpuImageLoad();
    [GeneratedRegex(@"'sys_fs_stat' failed (?!with 0x8001002c).+“(/dev_bdvd/(?<broken_filename_or_dir>.+)|/dev_hdd0/game/NP\w+/(?<broken_digital_filename>.+))”.*?$", DefaultOptions)]
    private static partial Regex SysFsStatFailed();
    [GeneratedRegex(@"'sys_fs_open' failed (?!with 0x8001002c).+“(/dev_bdvd/(?<broken_filename>.+)|/dev_hdd0/game/NP\w+/(?<broken_digital_filename>.+))”.*?$", DefaultOptions)]
    private static partial Regex SysFsOpenFailed();
    [GeneratedRegex(@"'sys_fs_opendir' failed .+“/dev_bdvd/(?<broken_directory>.+)”.*?$", DefaultOptions)]
    private static partial Regex SysFsOpenDirFailed();
    [GeneratedRegex(@"EDAT: Block at offset (?<edat_block_offset>0x[0-9a-f]+) has invalid hash!.*?$", DefaultOptions)]
    private static partial Regex InvalidEdat();
    [GeneratedRegex(@"(?<fw_missing_msg>PS3 firmware is not installed[^\r\n]+)\r?$", DefaultOptions)]
    private static partial Regex FwNotInstalled();
    [GeneratedRegex(@"(?<fw_missing_something>do you have the PS3 firmware installed[^\r\n]*)\r?$", DefaultOptions)]
    private static partial Regex FwNotInstalled2();
    [GeneratedRegex(@"U \d+:\d+:\d+\.\d+ ({(?<unimplemented_syscall_context>.+?)} )?.*Unimplemented syscall (?<unimplemented_syscall>[^\r\n]*)\r?$", DefaultOptions)]
    private static partial Regex UnimplementedSyscall();
    [GeneratedRegex(@"cellAudio: Could not enqueue buffer onto audio backend(?<enqueue_buffer_error>.).*$", DefaultOptions)]
    private static partial Regex CellAudioEnqueueFailed();
    [GeneratedRegex(@"{PPU\[.+\]} (?<log_channel>[^ :]+)( TODO)?: (?!“)(?<syscall_name>[^ :]+?)\(.*$", DefaultOptions)]
    ...
    [GeneratedRegex(@"⁂ (?<syscall_name>[^ :\[]+?) .*$", DefaultOptions)]
